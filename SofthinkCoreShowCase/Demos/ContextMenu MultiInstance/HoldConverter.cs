...
namespace SofthinkCoreShowCase.Demos.ContextMenu_MultiInstance
{
    public class HoldConverter :Freezable, IValueConverter 
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var pt = ((UIElement)tap.Container).PointToScreen(new Point());
            return new PostitViewModel() { Text = RandomHelper.GetRandomSmallerThan(50), Position = (Point)(VisualReference.PointFromScreen(pt) - new Point(75, 75)) , Color = Color };
        }
